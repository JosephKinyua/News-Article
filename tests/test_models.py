...
class TestArticle(unittest.TestCase):
  ...
  def test_initialization(self):
    ...
    self.assertEqual(self.new_article.urlToImage, 'https://live-production.wcms.abc-cdn.net.au/11b9c49c382e18ffce7d88caa1cf805f?impolicy=wcms_crop_resize&cropH=2813&cropW=5000&xPos=0&yPos=13&width=862&height=485')
